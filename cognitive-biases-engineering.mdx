...
```text
  ...
  ──────────────────────────────────────────────────────────
  Bias                  What Happens              Cost
  ───────────────────── ───────────────────────── ─────────────
  Confirmation Bias     See what you expect       Miss real bugs
  Survivorship Bias     Learn from survivors only Wrong conclusions
  Sunk Cost Fallacy     Throw good money after bad Waste resources
  Dunning-Kruger        Overestimate competence   Take wrong risks
  Hindsight Bias        "I knew it all along"     Learn nothing
  Bandwagon Effect      Follow the crowd          Copy bad choices
  Anchoring             First number sticks       Wrong estimates
  Availability          Recent = probable         Misread risks
```
...
```python title="survivorship_bias_simulation.py"
import numpy as np
