...
If your immediate answer was 1 USD, that was System 1 talking. The correct answer is 0.50 USD (the board costs 10.50 USD, the sensor costs 0.50 USD, and the difference is 10 USD). Most people, including engineers, get this wrong on first instinct because System 1 substitutes the easier problem ("11 minus 10") for the actual algebraic relationship.
